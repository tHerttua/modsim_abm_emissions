...
class Agent:
    def __init__(self, emissions_amount,
        ...
        self.emission_ever_had = emissions_amount
        self.emission_have_reduced = 0
    ...
    def update_selling_price(self, step):
        ...
        if len(self.deals_sold[step]) != 0:
            ...
            self.min_selling_price = max(self.original_price, self.min_selling_price - abs(self.original_price - self.min_selling_price) * UPDATE_RATE)
    ...
    def update_buying_price(self, step):
        ...
        if len(self.deals_bought[step]) != 0:
            ...
            self.max_buying_price = self.max_buying_price + abs(self.max_buying_price - self.original_price) * UPDATE_RATE
